...
public class OI {
    ...
    public JoystickButton gathererArmMiddleButtonThree;
    ...
    public OI() {
        ...
        gathererArmMiddleButtonThree = new JoystickButton(operatorJoystick, 3);
        gathererArmMiddleButtonThree.whileHeld(new GathererArmMiddle());
        ...
        SmartDashboard.putData("GathererArmMiddle", new GathererArmMiddle());
