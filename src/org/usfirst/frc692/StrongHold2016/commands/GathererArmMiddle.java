 ...
 *
 */
public class GathererArmMiddle extends Command {
    ...
    protected void initialize() {
    	Robot.gatherer.armPosition = Gatherer.ArmPositions.Middle;
    }

    // Called repeatedly when this Command is scheduled to run
    protected void execute() {
    	if(! RobotMap.gathererlimitSwitchMiddle.get()){
    ...
    protected boolean isFinished() {
        return RobotMap.gathererlimitSwitchMiddle.get();
    }
