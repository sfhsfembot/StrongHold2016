...
public class DriveWithTwoJoysticks extends Command {
    ...
    protected void execute() {
    	 ...
    	 SmartDashboard.putNumber("rightJoystick", Robot.oi.rightJoystick.getY());
         SmartDashboard.putNumber("leftJoystick", Robot.oi.leftJoystick.getY());
